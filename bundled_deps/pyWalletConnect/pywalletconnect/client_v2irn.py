...
class WCv2Client(WCClient):
    ...
    def __init__(self, ws_url, topic, symkey, socks_opts=None):
        ...
        self.socks_opts = socks_opts
        try:
            self.websock = WebSocketClient(ws_url, self.origin_domain, socks_opts=self.socks_opts)
    ...
    @classmethod
    def from_wc2_uri(cls, wc_uri_str, socks_opts):
        ...
        return cls(wsurl, handshake_topic, bytes.fromhex(sym_key_hex), socks_opts)
