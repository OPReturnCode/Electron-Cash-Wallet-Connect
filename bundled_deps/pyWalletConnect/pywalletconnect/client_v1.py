...
class WCv1Client(WCClient):
    ...
    def __init__(self, ws_url, topic, symkey, socks_opts=None):
        ...
        try:
            self.websock = WebSocketClient(ws_url, socks_opts=self.socks_opts)
    ...
    @classmethod
    def from_wc1_data(cls, wc_data, socks_opts):
        ...
        return cls(bridge_url, handshake_topic, sym_key, socks_opts)
