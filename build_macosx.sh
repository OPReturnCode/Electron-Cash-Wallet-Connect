...
unzip tmp/cryptography/cryptography-43.0.1-cp39-abi3-macosx_10_9_universal2.whl -d tmp/cryptography/
...
cd tmp
zip -r "walletconnect_macosx.zip" "walletconnect/" "manifest.json"
cd ..

cp tmp/walletconnect_macosx.zip build
rm -r tmp